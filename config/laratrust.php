...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Laratrust UserController Models
    |--------------------------------------------------------------------------
    |
    ...
    */
    'tables' => [
        ...
        /**
         * Role - UserController intermediate table.
         */
        'role_user' => 'role_user',

        /**
         * Permission - UserController intermediate table.
         */
    ...
    */
    'foreign_keys' => [
        /**
         * UserController foreign key on Laratrust's role_user and permission_user tables.
         */
        'user' => 'user_id',
    ...
    */
    'middleware' => [
        ...
        'handlers' => [
            ...
            'abort' => [
                'code' => 403,
                'message' => 'UserController does not have any of the necessary access rights.'
            ],
            /**
