...
@section('content')
    ...
    <div class="logo">
    <!-- <a href="#">
            <img src="{{ asset('/uploads/logos').'/'.setting('company.logo','') }}" alt="HRM - HTC" />
        </a> -->
        <h3 class="font-green">HTC Humen Resource Management System</h3>
    </div>
    <!-- END LOGO -->
    <!-- BEGIN LOGIN -->
...
{{--    <div class="copyright"> v1.0.0© <a href="{{ setting('company.website','') }}" target="_blank">{{ setting('company.name','') }}</a></div>--}}
